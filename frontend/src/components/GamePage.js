        ...
        <div className={`player-times-wrapper ${localPlayer === 2 ? 'reverse' : ''}`}>
          <div className={`player-wrapper ${currentPlayer === 1 ? 'active' : ''} whiteborder`}>
            <div className="player-time">
              {Math.floor(playerTimes[1] / 60)}:
              {String(Math.floor(playerTimes[1] % 60)).padStart(2, '0')}:
              {String(Math.floor((playerTimes[1] % 1) * 10 ** decimalPlaces)).padStart(
                decimalPlaces,
                '0'
              )}
            </div>
          ...
          <div className={`player-wrapper ${currentPlayer === 2 ? 'active' : ''} blackborder`}>
            <div className="player-time">
              {Math.floor(playerTimes[2] / 60)}:
              {String(Math.floor(playerTimes[2] % 60)).padStart(2, '0')}:
              {String(Math.floor((playerTimes[2] % 1) * 10 ** decimalPlaces)).padStart(
                decimalPlaces,
                '0'
              )}
            </div>
